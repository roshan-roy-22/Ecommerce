...
function Cart() {
  ...
  const handleCheckout = () => {
    alert(
      "Your order ha succesfully placed . thank you for purchasing with us"
    );
    dispatch(emptyCart());
    navigate("/");
  };
        ...
        {cart?.length > 0 ? (
          <div className="row mt-5">
            ...
            <div className="col-lg-4 mt-5">
              <div className="shadow border rounded p-4">
                ...
                <h3>
                  Total Amount:{" "}
                  <span className="fw-bolder text-danger">{cartAmount}</span>
                </h3>
                <hr />
          ...
          <div className="text-center mt-5">
            <img
              width={"25%"}
              height={"200px"}
              src="https://16stitches.com/assets/frontend/images/empty_cart.png"
              alt=""
            />
